...
<template>
<div id="table-holder" class="table-holder max-w-[18rem] sm:max-w-screen-sm md:max-w-[100%]  overflow-auto">
    <table class=" md:w-full  p-8 block md:table  overflow-auto whitespace-nowrap">
        <thead class="w-full bg-gray-100 rounded-r-sm border-b">
        ...
        <tbody class="w-full">
            <tr class="rounded-2xl " v-for="item in transactions">
                ...
                <td class="text-left p-3 text-sm font-bold">{{ item.amount }}</td>
