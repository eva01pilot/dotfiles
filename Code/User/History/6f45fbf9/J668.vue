...
<template>
    <li class="grid grid-cols-[3fr_auto]">
        <div class="grid grid-cols-[1fr_3fr]">
            <div class="flex justify-center items-center">
                <i class="w-8 h-8"><component :is="props.icon" /></i>
            </div>
            <div class="flex font-bold justify-start items-center text-left flex-row">
        ...
        <div class="col-span-3 " v-if="dropdownItems?.length">
            <ul class="ml-[4.5rem] " v-if="open" v-for="item in dropdownItems">
                <li class="p-2">
                    {{ item }}
                </li>
            </ul>
