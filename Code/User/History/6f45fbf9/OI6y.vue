...
<template>
    <li class=" ">
        <div :class="`grid grid-cols-[1fr_3fr_1fr] ${ open && 'bg-gray-100 rounded-xl'}`">
            <div class="flex justify-center items-center">
                <i :class="`w-8 h-8 ${active && 'text-blue-600'}`"><component :is="props.icon" /></i>
            </div>
            <div :class="`${active && 'text-blue-600'} flex justify-start items-center text-left flex-row`">
