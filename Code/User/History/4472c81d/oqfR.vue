...
<template>
    <div class="w-full h-[calc(100vh-10vh)] max-h-[calc(100vh-10vh)] flex justify-between items-center flex-col">
        <div class="h-5/6 flex items-center justify-between md:flex-col flex-row">
