        ...
        <div class="h-5/6 flex items-center justify-between flex-col md:flex-row">
            ...
            <div class="grid grid-cols-2 gap-2">
                <a-card v-if="ready['contact']">
                    ...
                    <a-statistic v-if="ready['contact'].total" title="Валидных контактов" :value="ready['contact'].total - ready['contact'].current" :suffix="`/${countValues['contact']}`"  />
                </a-card>
                <a-card v-if="ready['lead']">
                    ...
                    <a-statistic v-if="ready['lead'].total" title="Валидных лидов" :value="ready['lead'].total - ready['lead'].current" :suffix="`/${countValues['lead']}`"  />
                </a-card>
            </div>
        </div>
