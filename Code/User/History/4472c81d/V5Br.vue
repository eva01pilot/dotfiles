...
const startParsing = async () => {
    ...
    for(const entity  of entitiesTypes){
        ...
        for (const [i, lead] of leads.entries()) {
            console.log(i, countValues.value);
...
<template>
    <div class="w-full h-[calc(100vh-10vh)] flex justify-between items-center flex-col">
        <div class="h-5/6 flex items-center justify-between flex-col">
